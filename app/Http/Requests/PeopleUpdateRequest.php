...
class PeopleUpdateRequest extends FormRequest
{
    ...
    {   
        //dd($this->titulare);//parametro que se pasa atraves de la ruta para omitir el valor dni
        return [
            'first_name'        => 'required',
            'last_name'         => 'required',
            'dni'               => 'required|unique:people,dni,' . $this->titulare,
    ...
    public function messages()
    {
        return [
            ...
            'dni'                       => 'La cedula del titular es requerido.',
